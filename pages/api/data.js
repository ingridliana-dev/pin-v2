...
export default function handler(req, res) {
  ...
  const { since, processed, markProcessed, single } = req.query;
  ...
  if (since) {
    ...
    filteredData = filteredData.filter(item => new Date(item.timestamp) > sinceDate);
  }
